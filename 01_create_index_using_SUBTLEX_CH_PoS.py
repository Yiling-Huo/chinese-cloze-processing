...
# step 1: create an index file containing only nouns from SUBTLEX-CH-WF_PoS
...
# these include common and proper nouns
pos = ['n', 'ng', 'nr', 'ns', 'nt', 'nx', 'nz']
...
# create an index file with only nouns
...
print('Total number of nouns: ' + str(i))
print('Done.')
